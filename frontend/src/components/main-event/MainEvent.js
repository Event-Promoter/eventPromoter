  ...
  return (
    <div>
      ...
      <div className="side">
        ...
        <div className="desc">
          <h4 className="text-work">
            Registered Users : 5000 &emsp; &emsp; &emsp; &emsp; &emsp;Allowed
            Team Size: 1 to 4
          </h4>
        </div>
        <div className="desc2">
      ...
      >
        ...
        >
          ...
          >
            ...
            Chapter. Pulzion has hosted multiple events including coding
            ...
            aims to add value to the college and all the people in it. It has
            become one of the most anticipated events taking place at PICT with
            participants from colleges all over Pune. With high aspirations,
            backed with sincerity and dedication, the PASC team aims to add
            value to the college and all the people in it.
          </Typography>
        </Typography>
      </Container>
      <Container maxWidth="xl">
        <Typography
          component="div"
          style={{ backgroundColor: "#white", height: "60vh", marginTop: "5%" }}
        >
          {/* There is already an h1 in the page, let's not duplicate it. */}
